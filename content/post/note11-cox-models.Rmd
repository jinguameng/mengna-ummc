...
- <span style="color:orange">$\lambda _0 (t):$</span> this is the baseline hazard function at time t, which is analogous to the intercept term in a multiple regression or logistic regression model.  
...
- <span style="color:purple">Hazard Ratio</span>: similar with odds ratio.  

- <span style="color:purple">Continuous</span>: A unit increase in X is associated with a YY% increase/decrease in the hazard of (event) on average.  

- <span style="color:purple">Binary</span>: On average, A has YY% higher/lower hazard of (event) compared to B.
